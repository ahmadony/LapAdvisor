...
public partial class LapAdvisorDbContext : IdentityDbContext<ApplicationUser>
{
    public LapAdvisorDbContext()
    {

    }

    public LapAdvisorDbContext(DbContextOptions<LapAdvisorDbContext> options)
        : base(options)
    {
    }
