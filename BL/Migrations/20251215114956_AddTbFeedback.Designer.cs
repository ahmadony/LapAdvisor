...
{
    [DbContext(typeof(LapAdvisorDbContext))]
    [Migration("20251215114956_AddTbFeedback")]
    partial class AddTbFeedback
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domains.TbFeedback", b =>
                {
                    b.Property<int>("TbFeedbackId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TbFeedbackId"));
            ...
            modelBuilder.Entity("LapAdvisor.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("LapAdvisor.Models.TbBusinessInfo", b =>
                {
            ...
            modelBuilder.Entity("LapAdvisor.Models.TbCashTransacion", b =>
                {
            ...
            modelBuilder.Entity("LapAdvisor.Models.TbCategory", b =>
                {
            ...
            modelBuilder.Entity("LapAdvisor.Models.TbCustomer", b =>
                {
                    b.Property<int>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapAdvisor.Models.TbItem", b =>
                {
                    b.Property<int>("ItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapAdvisor.Models.TbItemDiscount", b =>
                {
            ...
            modelBuilder.Entity("LapAdvisor.Models.TbItemImage", b =>
                {
            ...
            modelBuilder.Entity("LapAdvisor.Models.TbItemType", b =>
                {
                    b.Property<int>("ItemTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapAdvisor.Models.TbO", b =>
                {
                    b.Property<int>("OsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapAdvisor.Models.TbPages", b =>
                {
            ...
            modelBuilder.Entity("LapAdvisor.Models.TbPurchaseInvoice", b =>
                {
            ...
            modelBuilder.Entity("LapAdvisor.Models.TbPurchaseInvoiceItem", b =>
                {
            ...
            modelBuilder.Entity("LapAdvisor.Models.TbSalesInvoice", b =>
                {
                    b.Property<int>("InvoiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapAdvisor.Models.TbSalesInvoiceItem", b =>
                {
                    b.Property<int>("InvoiceItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapAdvisor.Models.TbSlider", b =>
                {
            ...
            modelBuilder.Entity("LapAdvisor.Models.TbSupplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapAdvisor.Models.TbWishlist", b =>
                {
            ...
            modelBuilder.Entity("LapAdvisor.Models.VwItem", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapAdvisor.Models.VwItemCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapAdvisor.Models.VwItemsOutOfInvoice", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(100)
            ...
            modelBuilder.Entity("LapAdvisor.Models.VwSalesInvoice", b =>
                {
                    b.Property<Guid>("CustomerId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LapAdvisor.Models.TbBusinessInfo", b =>
                {
                    b.HasOne("LapAdvisor.Models.TbCustomer", "Cutomer")
                        .WithOne("TbBusinessInfo")
                        .HasForeignKey("LapAdvisor.Models.TbBusinessInfo", "CutomerId")
            ...
            modelBuilder.Entity("LapAdvisor.Models.TbItem", b =>
                {
                    b.HasOne("LapAdvisor.Models.TbCategory", "Category")
                        .WithMany("TbItems")
                        .HasForeignKey("CategoryId")
                        .IsRequired()
                        .HasConstraintName("FK_TbItems_TbCategories");

                    b.HasOne("LapAdvisor.Models.TbItemType", "ItemType")
                        .WithMany("TbItems")
                        .HasForeignKey("ItemTypeId")
                        .HasConstraintName("FK_TbItems_TbItemTypes");

                    b.HasOne("LapAdvisor.Models.TbO", "Os")
                        .WithMany("TbItems")
                        .HasForeignKey("OsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("LapAdvisor.Models.TbItemDiscount", b =>
                {
                    b.HasOne("LapAdvisor.Models.TbItem", "Item")
            ...
            modelBuilder.Entity("LapAdvisor.Models.TbPurchaseInvoice", b =>
                {
                    b.HasOne("LapAdvisor.Models.TbSupplier", "Supplier")
            ...
            modelBuilder.Entity("LapAdvisor.Models.TbPurchaseInvoiceItem", b =>
                {
                    b.HasOne("LapAdvisor.Models.TbPurchaseInvoice", "Invoice")
            ...
            modelBuilder.Entity("LapAdvisor.Models.TbSalesInvoiceItem", b =>
                {
                    b.HasOne("LapAdvisor.Models.TbSalesInvoice", "Invoice")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LapAdvisor.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TbCustomerItem", b =>
                {
                    b.HasOne("LapAdvisor.Models.TbCustomer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LapAdvisor.Models.TbItem", null)
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
